...
// import VoiceRecognition from "@/plugins/voice-recognition";
...
export default {
  ...
  watch: {
    ...
    isSpeaking_val() {
      ...
      if (this.$store.state.selected && this.$store.state.isSpeaking) {
        ...
        // to_modify_area.style.backgroundColor = "#E0E0E0"
        // to_modify_area.style.margin = "10px 0"
        ...
        speaking_area.style.backgroundColor = "#C5E1A5";
        speaking_area.style.marginBottom = "10px";
        speaking_area.style.minHeight = "30px";
  ...
  methods: {
    ...
    releaseSpeak: function () {
      ...
      //   this.voice2text = VoiceRecognition.getVoice2Text();
